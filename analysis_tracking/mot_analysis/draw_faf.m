function draw_faf
    ...
    set(gca, 'TickDir', 'in');
    set(gca, 'ZTick', 0.5:0.2:2);
    annotation(figure1,'textbox', [0.15 0.99 0.01 0.01], 'String',{'(c)'}, 'FontSize',10, 'FitBoxToText','off', 'EdgeColor','none');
    saveas(gcf, 'pic/far.bmp');
