function draw_ids_score_9
    ...
    text(30, y1(3)+15, num2str(y1(3)));
    text(40, y2(4)+15, num2str(y2(4)));
    text(40, y3(4)+10, num2str(y3(4)));
    text(40, y4(4)-10, num2str(y4(4)));
    ...
    saveas(gcf, 'pic/ids-score-9.bmp');
