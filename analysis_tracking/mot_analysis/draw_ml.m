function draw_ml
    ...
    set(gca, 'TickDir', 'in');
    set(gca, 'ZTick', 110:10:170);
    annotation(figure1,'textbox', [0.15 0.99 0.01 0.01], 'String',{'(e)'}, 'FontSize',10, 'FitBoxToText','off', 'EdgeColor','none');
    saveas(gcf, 'pic/ml.bmp');
