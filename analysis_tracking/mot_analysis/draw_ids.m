function draw_ids
    ...
    set(gca, 'TickDir', 'in');
    annotation(figure1,'textbox', [0.15 0.99 0.01 0.01], 'String',{'(h)'}, 'FontSize',10, 'FitBoxToText','off', 'EdgeColor','none');
    saveas(gcf, 'pic/ids.bmp');    
