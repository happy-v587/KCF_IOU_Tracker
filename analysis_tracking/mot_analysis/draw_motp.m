...
%     axis([1 9 10 40 30 40]);
    ...
    set(gca, 'TickDir', 'in');
    set(gca, 'ZTick', 71.5:0.2:72.5);
    
    annotation(figure1,'textbox', [0.15 0.99 0.01 0.01], 'String',{'(b)'}, 'FontSize',10, 'FitBoxToText','off', 'EdgeColor','none');    
    saveas(gcf, 'pic/motp.bmp');
