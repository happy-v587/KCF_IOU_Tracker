...
obj.trainPathImages = 'F:/MOT16/train/%s/img1/%s.jpg';
obj.testPathImages  = 'F:/MOT16/test/%s/img1/%s.jpg';

obj.trainPathGt     = 'F:/MOT16/train/%s/gt/gt.txt';

%% result path

if param.is_train
        
    obj.trainPathDet = 'F:/MOT16/train/%s/det/det.txt';    
    obj.resultPath = sprintf('result/det-base-mot16/train/k%.0f-s%.0f-c%.1f', ...
